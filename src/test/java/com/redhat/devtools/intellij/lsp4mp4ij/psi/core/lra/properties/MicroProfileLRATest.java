 ...
 */
public class MicroProfileLRATest extends LSP4MPMavenModuleImportingTestCase {

    @Test
    public void testMicroprofileLRA() throws Exception {

        Module module = loadMavenProject(MicroProfileMavenProjectName.microprofile_lra);

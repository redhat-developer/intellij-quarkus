 ...
 *******************************************************************************/
package com.redhat.devtools.intellij.lsp4mp4ij.psi.core.contextpropagation.properties;
 ...
 */
public class MicroProfileContextPropagationTest extends LSP4MPMavenModuleImportingTestCase {

    @Test
    public void testMicroprofileContextPropagation() throws Exception {

        Module module = loadMavenProject(MicroProfileMavenProjectName.microprofile_context_propagation);

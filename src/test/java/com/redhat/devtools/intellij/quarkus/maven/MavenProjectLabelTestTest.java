 ...
 */
public class MavenProjectLabelTestTest extends MavenImportingTestCase {

	@Test
	public void testGetProjectLabelQuarkusMaven() throws Exception {
		Module module = createMavenModule("using-vertx", new File("projects/maven/using-vertx"));
		...
		ProjectLabelInfoEntry projectLabelEntry = ProjectLabelManager.getInstance().getProjectLabelInfo(projectLabelsParams, PsiUtilsImpl.getInstance());

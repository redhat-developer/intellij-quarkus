...
public class QuarkusLanguageClient extends IndexAwareLanguageClient implements MicroProfileLanguageClientAPI, ClasspathResourceChangedManager.Listener {
    ...
    Map<Module, ProjectInfoState> projectInfoStates = new ConcurrentHashMap<>();

    private enum ProjectInfoState {
        Unset, Computing, Computed;
    }
    ...
    public void librariesChanged() {
        ...
        for (var module : ModuleManager.getInstance(getProject()).getModules()) {
            projectInfoStates.put(module, ProjectInfoState.Unset);
        }
    ...
    public CompletableFuture<MicroProfileProjectInfo> getProjectInfo(MicroProfileProjectInfoParams params) {
        ...
        ProjectInfoState state = projectInfoStates.getOrDefault(module, ProjectInfoState.Unset);
        if (ProjectInfoState.Computed.equals(state) || ProjectInfoState.Computing.equals(state)) {
            ...
            Runnable task = () -> ProgressManager.getInstance().run(new Task.Backgroundable(getProject(), "Computing deployment jars...") {
                ...
                public void run(@NotNull ProgressIndicator indicator) {
                    ...
                    try {
                        ...
                        projectInfoStates.put(module, ProjectInfoState.Computing);
                        ...
                        projectInfoStates.put(module, ProjectInfoState.Computed);
                        future.complete(true);
                    } catch (Exception e) {
                        if (module != null) {
                            projectInfoStates.put(module, ProjectInfoState.Computed);

...
import com.redhat.devtools.intellij.quarkus.search.core.MicroProfileConfigConstants;
...
public class PsiMicroProfileUtils {
	...
	public static String getProjectURI(Module project) {
		return PsiUtilsImpl.getProjectURI(project);
	}
	...
	public static boolean isMicroProfileProject(Module javaProject) {
		return PsiUtilsImpl.getInstance().findClass(javaProject, MicroProfileConfigConstants.CONFIG_PROPERTY_ANNOTATION) != null;
	}
}
